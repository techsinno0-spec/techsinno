...
const T = {
  en: {
    ...
    s1_title: 'B2B ELECTRONICS\nREPAIR',
    s1_desc: 'PCB-level fault finding, component replacement, and functional testing for industrial and commercial electronics.',
    s1_link: 'Request repair',
    s2_title: 'INDUSTRIAL\nAUTOMATION',
    s2_desc: 'PLC programming, SCADA integration, and automated control systems for manufacturing and process plants.',
    s2_link: 'Start a project',
