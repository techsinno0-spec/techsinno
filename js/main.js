...
const T = {
  en: {
    ...
    sa_desc: 'Based in Cape Town, Western Cape — serving industrial, agricultural, and commercial clients across all of South Africa, with growing presence in Johannesburg, Pretoria, and the Free State.',
    drc_title: 'DR CONGO',
  ...
  fr: {
    ...
    sa_desc: "Basés au Cap (Cape Town), Western Cape — au service de clients industriels, agricoles et commerciaux dans toute l'Afrique du Sud, avec une présence croissante à Johannesburg, Pretoria et dans le Free State.",
    drc_title: 'RD CONGO',
  ...
  af: {
    ...
    sa_desc: 'Gebaseer in Kaapstad, Wes-Kaap — ons bedien kliënte regoor Suid-Afrika, met groeiende teenwoordigheid in Johannesburg, Pretoria en die Vrystaat.',
    drc_title: 'DR KONGO',
  ...
  pt: {
    ...
    sa_desc: 'Sediados na Cidade do Cabo, Western Cape — servindo clientes em toda a África do Sul, com presença crescente em Joanesburgo, Pretória e no Free State.',
    drc_title: 'RD CONGO',
