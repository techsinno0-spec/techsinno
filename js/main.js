...
const T = {
  en: {
    ...
    fb_label: 'Your voice',
    fb_title: 'FEEDBACK &amp; REVIEWS',
    fb_desc: 'Worked with us, or have a thought to share? We\'d love to hear it — a review, a suggestion, or a concern. Every message reaches us directly.',
    fb_t_review: 'Review',
    fb_t_suggestion: 'Suggestion',
    fb_t_complaint: 'Complaint',
    fb_t_general: 'General',
    fb_rating: 'Your rating (optional):',
    fb_name: 'Name',
    fb_email: 'Email',
    fb_company: 'Company (optional)',
    fb_message: 'Your message',
    fb_msg_ph: 'Tell us about your experience...',
    fb_consent: 'I\'m happy for TECHSINNO to publish my review as a testimonial.',
    ...
    about_p1: 'We started TECHSINNO with a simple belief: that world-class engineering should be accessible, honest, and built to last. From a single workbench in Kuilsriver, we now help businesses across two countries solve real hardware problems.',
    about_p2: 'Whether it is repairing a critical industrial board, designing a custom PCB, automating a production line, or bringing a farm online with smart sensors — we treat every project as if our name depends on it. Because it does.',
    about_p3: 'Led by a practising mechatronics and electronics engineer, we pair deep hands-on hardware skill with modern cloud and software know-how — the old craft and the new tools, working together.',
    sa_title: 'SOUTH AFRICA',
    sa_desc: 'Based in Cape Town, Western Cape — serving industrial, agricultural, and commercial clients across all of South Africa, and available for projects in Johannesburg, Pretoria, and the Free State.',
    drc_title: 'DR CONGO',
    drc_desc: 'On-the-ground representation in Kolwezi and Lubumbashi, expanding across the DRC including Kinshasa — and open to projects worldwide.',
    ...
    fl_e1: 'info@techsinno.com',
    fl_e2: 'Cape Town, Western Cape',
  ...
  fr: {
    ...
    nav_feedback: 'Avis',
    fb_label: 'Votre voix',
    fb_title: 'AVIS &amp; COMMENTAIRES',
    fb_desc: 'Vous avez travaillé avec nous ou avez une idée à partager ? Nous aimerions l\'entendre — un avis, une suggestion ou une préoccupation. Chaque message nous parvient directement.',
    fb_t_review: 'Avis',
    fb_t_suggestion: 'Suggestion',
    fb_t_complaint: 'Réclamation',
    fb_t_general: 'Général',
    fb_rating: 'Votre note (facultatif) :',
    fb_name: 'Nom',
    fb_email: 'Email',
    fb_company: 'Entreprise (facultatif)',
    fb_message: 'Votre message',
    fb_msg_ph: 'Parlez-nous de votre expérience...',
    fb_consent: 'J\'accepte que TECHSINNO publie mon avis comme témoignage.',
    fb_submit: 'Envoyer →',
    stat2: 'PAYS',
    stat3: 'SERVICES',
    stat4: 'LANGUES',
    ...
    about_p1: "Nous avons fondé TECHSINNO avec une conviction simple : l'ingénierie de classe mondiale doit être accessible, honnête et durable. Depuis un seul atelier à Kuilsriver, nous aidons aujourd'hui des entreprises dans deux pays à résoudre de vrais problèmes matériels.",
    about_p2: "Qu'il s'agisse de réparer une carte industrielle critique, de concevoir un PCB sur mesure, d'automatiser une ligne de production ou de connecter une ferme avec des capteurs intelligents — nous traitons chaque projet comme si notre réputation en dépendait. Parce que c'est le cas.",
    about_p3: "Dirigée par un ingénieur en mécatronique et électronique en exercice, nous associons un savoir-faire matériel approfondi aux outils cloud et logiciels modernes — l'ancien métier et les nouveaux outils, ensemble.",
    sa_title: 'AFRIQUE DU SUD',
    sa_desc: "Basés au Cap (Cape Town), Western Cape — au service de clients industriels, agricoles et commerciaux dans toute l'Afrique du Sud, et disponibles pour des projets à Johannesburg, Pretoria et dans le Free State.",
    drc_title: 'RD CONGO',
    drc_desc: "Représentation locale à Kolwezi et Lubumbashi, en expansion dans toute la RDC y compris Kinshasa — et ouverts aux projets dans le monde entier.",
    ...
    fl_e1: 'info@techsinno.com', fl_e2: 'Cape Town, Western Cape', fl_e3: 'Afrique du Sud & RDC',
  ...
  af: {
    ...
    stat1: 'JAAR ERV',
    nav_feedback: 'Terugvoer',
    fb_label: 'U stem',
    fb_title: 'TERUGVOER &amp; RESENSIES',
    fb_desc: 'Het u met ons gewerk, of het u \'n gedagte om te deel? Ons wil graag hoor — \'n resensie, voorstel of bekommernis. Elke boodskap bereik ons direk.',
    fb_t_review: 'Resensie',
    fb_t_suggestion: 'Voorstel',
    fb_t_complaint: 'Klagte',
    fb_t_general: 'Algemeen',
    fb_rating: 'U gradering (opsioneel):',
    fb_name: 'Naam',
    fb_email: 'E-pos',
    fb_company: 'Maatskappy (opsioneel)',
    fb_message: 'U boodskap',
    fb_msg_ph: 'Vertel ons van u ervaring...',
    fb_consent: 'Ek is gelukkig dat TECHSINNO my resensie as getuigskrif publiseer.',
    fb_submit: 'Stuur Terugvoer →',
    stat2: 'LANDE',
    stat3: 'DIENSLYNE',
    stat4: 'TALE',
    ...
    about_p1: 'Ons het TECHSINNO begin met \'n eenvoudige oortuiging: dat wêreldklas-ingenieurswese toeganklik, eerlik en blywend moet wees. Vanaf een werkbank in Kuilsrivier help ons nou besighede oor twee lande heen om werklike hardeware-probleme op te los.',
    about_p2: 'Of dit nou \'n kritieke industriële bord herstel, \'n pasgemaakte PCB ontwerp, \'n produksielyn outomatiseer, of \'n plaas aanlyn bring met slim sensors — ons behandel elke projek asof ons naam daarvan afhang. Want dit doen.',
    about_p3: 'Gelei deur \'n praktiserende megatronika- en elektroniese ingenieur, kombineer ons diep praktiese hardeware-vaardigheid met moderne wolk- en sagteware-kennis — die ou ambag en die nuwe gereedskap, saam.',
    sa_title: 'SUID-AFRIKA',
    sa_desc: 'Gebaseer in Kaapstad, Wes-Kaap — ons bedien kliënte regoor Suid-Afrika, en beskikbaar vir projekte in Johannesburg, Pretoria en die Vrystaat.',
    drc_title: 'DR KONGO',
    drc_desc: 'Plaaslike verteenwoordiging in Kolwezi en Lubumbashi, met uitbreiding regoor die DRK insluitend Kinshasa — en oop vir projekte wêreldwyd.',
    ...
    fl_e1: 'info@techsinno.com', fl_e2: 'Kaapstad, Wes-Kaap', fl_e3: 'Suid-Afrika & DRK',
    copy: '© 2026 TECHSINNO (Pty) Ltd — Alle regte voorbehou.',
    nav_process: 'Proses',
    nav_login: 'Kliënt Aanmelding',
  ...
  pt: {
    ...
    stat1: 'ANOS EXP',
    nav_feedback: 'Avaliações',
    fb_label: 'A sua voz',
    fb_title: 'AVALIAÇÕES &amp; OPINIÕES',
    fb_desc: 'Trabalhou connosco ou tem uma ideia a partilhar? Gostaríamos de a ouvir — uma avaliação, sugestão ou preocupação. Cada mensagem chega-nos directamente.',
    fb_t_review: 'Avaliação',
    fb_t_suggestion: 'Sugestão',
    fb_t_complaint: 'Reclamação',
    fb_t_general: 'Geral',
    fb_rating: 'A sua classificação (opcional):',
    fb_name: 'Nome',
    fb_email: 'Email',
    fb_company: 'Empresa (opcional)',
    fb_message: 'A sua mensagem',
    fb_msg_ph: 'Conte-nos sobre a sua experiência...',
    fb_consent: 'Autorizo a TECHSINNO a publicar a minha avaliação como testemunho.',
    fb_submit: 'Enviar →',
    stat2: 'PAÍSES',
    stat3: 'SERVIÇOS',
    stat4: 'LÍNGUAS',
    ...
    about_p1: 'Fundámos a TECHSINNO com uma convicção simples: a engenharia de classe mundial deve ser acessível, honesta e duradoura. A partir de uma única bancada em Kuilsriver, ajudamos agora empresas em dois países a resolver problemas reais de hardware.',
    about_p2: 'Seja reparar uma placa industrial crítica, conceber um PCB personalizado, automatizar uma linha de produção ou ligar uma exploração com sensores inteligentes — tratamos cada projecto como se o nosso nome dependesse disso. Porque depende.',
    about_p3: 'Liderada por um engenheiro de mecatrónica e electrónica em exercício, combinamos profunda competência prática de hardware com conhecimento moderno de cloud e software — o ofício antigo e as novas ferramentas, juntos.',
    sa_title: 'ÁFRICA DO SUL',
    sa_desc: 'Sediados na Cidade do Cabo, Western Cape — servindo clientes em toda a África do Sul, e disponíveis para projetos em Joanesburgo, Pretória e no Free State.',
    drc_title: 'RD CONGO',
    drc_desc: 'Representação local em Kolwezi e Lubumbashi, em expansão por toda a RDC incluindo Kinshasa — e abertos a projetos em todo o mundo.',
    ...
    fl_e1: 'info@techsinno.com', fl_e2: 'Cape Town, Western Cape', fl_e3: 'África do Sul & RDC',
    copy: '© 2026 TECHSINNO (Pty) Ltd — Todos os direitos reservados.',
    nav_process: 'Processo',
    nav_login: 'Área de Cliente',
